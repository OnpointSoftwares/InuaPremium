...
if (isset($_POST['repay'])) {
    ...
    distributeRepayment($loan_id,$amount_paid,$conn);
}
function distributeRepayment($loan_id, $amount_paid, $conn) {
    ...
    $sql = "SELECT id, amount,paid, repayment_date 
            FROM repayments 
    ...
    return "<div class='alert alert-success'>Repayment successfully distributed to unpaid installments.</div>";
}
